...
def draw_quadrilateral(image_path, box_file_path):  
    ...
    output_path = os.path.join('/home/ultralytics/datasets/test', base_name + '_with_box.jpg') 
...
image_dir = '/home/ultralytics/datasets/OBBCrop/images/val'  # 替换为你的图像目录  
label_dir= '/home/ultralytics/datasets/OBBCrop/labels/val' 
